The hyper parameter are given as command line arguments. There are 3 files included:

1. single_layer_nn.py - Creates a single layer neural network.
2. two_layer_neural_network.py - Creates a two layer neural network
